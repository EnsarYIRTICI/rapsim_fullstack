...
import personalBackgroundImage from "../assets/images/personal_background.jpg";
...
export default function PersonalRegisterPage() {
  ...
  const signUp = async () => {
    try {
      ...
      const authData = await UserInformationService.SignUp(
